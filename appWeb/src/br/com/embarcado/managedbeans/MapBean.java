...
public class MapBean implements Serializable {
	...
	public void init() {
		...
		/*
		 * LatLng coord3 = new LatLng(36.879703, 30.706707); LatLng coord4 = new
		 * LatLng(36.885233, 30.702323);
		 */

		// Icons and Data

		advancedModel.addOverlay(new Marker(coord1, "FUCAPI", "",
				"http://maps.google.com/mapfiles/ms/micons/blue-dot.png"));
		advancedModel.addOverlay(new Marker(coord2, "FPF TECH", "",
	...
	public void pontoSelecionado(PointSelectEvent event) {
		...
		System.out.println("Lat:" + latituteLongitude.getLat() + ", Long:"
